...
class ContactFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_form" do
    assert_difference('ContactForm.count') do
      post contact_forms_url, params: { contact_form: { email: @contact_form.email, message: @contact_form.message, name: @contact_form.name, subject: @contact_form.subject } }
    end
  ...
  test "should update contact_form" do
    patch contact_form_url(@contact_form), params: { contact_form: { email: @contact_form.email, message: @contact_form.message, name: @contact_form.name, subject: @contact_form.subject } }
