...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { end_date: @education.end_date, location: @education.location, school: @education.school, specialization: @education.specialization, start_date: @education.start_date } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { end_date: @education.end_date, location: @education.location, school: @education.school, specialization: @education.specialization, start_date: @education.start_date } }
