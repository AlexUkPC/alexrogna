...
ActionText::RichText.create!(record_type: 'User',record_id: user.id, name: 'long_description_wysiwyg', body: "I'm a <strong>web designer</strong> and <strong>programmer</strong> specialized in creating useful applications and great websites. I've been in the field for more than <strong>5 years</strong> and have been loving every second of it! I'm an entrepreneur, designer, developer and overall a thinker.<br>I have experience in all phases of the project life cycle - <strong>analysis</strong>,<strong> design</strong>,<strong> coding</strong>, <strong>debugging</strong>, <strong>testing</strong>, <strong>deployment</strong>, <strong>implementation</strong> and <strong>monitoring</strong>.<br>My working experience is the proof that I can be an excellent asset to your company.")
...
ActionText::RichText.create!(record_type: 'Work',record_id: work5.id, name: 'key_responsibilities', body: "<ul><li>Coded, debugged, tested and documented web applications based on customer requests. </li><li>Designed, created, updated, assured security and backups for applications and servers.</li><li>Set up CI/CD pipelines to speed up the development process</li><li>Learned new tools and technologies to help me achieve my goals.</li></ul>")
...
project0 = Project.create!(name: "AlexRogna", url: "https://alexrogna.com/", github_url: "https://github.com/AlexUkPC/alexrogna", docker_url: "https://hub.docker.com/r/alexrogna/alexrogna_web", tag_ids: [tag4.id, tag5.id, tag7.id, tag9.id, tag11.id, tag12.id, tag16.id, tag18.id, tag20.id ], hidden: true, order_id: 101)
ActionText::RichText.create!(record_type: 'Project',record_id: project0.id, name: 'description', body: "This is my website built as an enhanced CV to show the projects I've worked on and the skills I've acquired over the years. It is highly customizable, being able to easily add/update contact details, projects, jobs, courses and acquired skills. Once I add new information to it, I can download the PDF file that contains my updated CV and use it to apply for jobs, so my CV is always up to date.<br>
I built the website using Ruby on Rails, Sass, Javascript and PostgreSQL. I have also configured the production server and created a CI/CD pipeline using Git, Docker and Jenkins to be able to manage versions and update the deployments on the server.")
...
ActionText::RichText.create!(record_type: 'Project',record_id: project2.id, name: 'description', body: "Eleca is a blog made for a passionate reader who wants to share with her followers her opinions about what she and her daughter read. She also inspires them with food recipes and handmade ideas.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project4.id, name: 'description', body: "Presentation website for a village in Romania that currently has no residents, the last one dying in 1998. It's a place that despite the fact that it's abandoned, it found a way to be reborn online. Therefore the descendets of people who lived there before won't forget about it, and hopefully one day they'll return where their famillies came from.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project6.id, name: 'description', body: "Presentation website for EWB Solutions which supplies bellows to many industries world-wide including: Aerospace, Vacuum Engineering, Chemical, Semiconductor, Medical, Nuclear, Pharmaceutical and Defence industries.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project8.id, name: 'description', body: "Presentation website for Awesome New Design shows a web development agency which offers affordable and creative solutions for all online needs like website design, e-commerce websites, CRM solutions, software development and branding.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project9.id, name: 'description', body: "For a long time in history there were only black and white pictures, then colour photos were invented. As I want to remember the black and white pictures, but also to add a splash of colour I made this platform for sharing black and orange photos with everyone. Users can view, like and comment on other user's photos.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project11.id, name: 'description', body: "This is a social network in which users can share their thoughts, photos and check in at different locations. They can also interact with other users by following them and being followed. If they follow someone, then, they can see in the main timeline what the other user post and respond to that. From the settings section users can change their profile photo, details, make the profile private or delete the account.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project12.id, name: 'description', body: "This is a travel blog made in Rails. A blogger can post an article on the website or he can send an email to a custom email address. With the help of Active Mailbox this is stored as an unpublished article linked with his account, which can be published later. When a new article is published on the blog, with the help of Action Cable everyone active on the website can see a notification for this event with a direct link to the article.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project14.id, name: 'description', body: "This is an eCommerce website built with Shopify for a catering company. It provides the user with a catalogue of different dishes available to order online. The client wanted to be able to process orders, accept payments, manage shipping and logistics, and to provide customer service.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project15.id, name: 'description', body: "Presentation website for a custom-made furniture company. They wanted to be able to update the website regularly and I've created a dashboard from which they can add/update projects, products and services. The admin can also moderate reviews, see all the contact form submissions and also can change contact details.<br>
...
ActionText::RichText.create!(record_type: 'Project',record_id: project16.id, name: 'description', body: "This is an enterprise resource planning platform custom built for the customer's needs. With the help of this app they can see an overview of the company's performance, make quick decisions and plan for the future.<br>
