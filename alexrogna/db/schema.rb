...
ActiveRecord::Schema.define(version: 2021_12_11_185304) do
  ...
  create_table "educations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "show_on_cv", default: true
    t.boolean "present"
  end

  create_table "educations_teches", id: false, force: :cascade do |t|
  ...
  create_table "skills_teches", id: false, force: :cascade do |t|
    t.bigint "tech_id", null: false
    t.bigint "skill_id", null: false
  end
  ...
  create_table "teches_works", id: false, force: :cascade do |t|
