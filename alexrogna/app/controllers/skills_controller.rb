class SkillsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @skill.save
        format.html { redirect_to root_path + "#skills", notice: "Skill was successfully created." }
  ...
  def update
    respond_to do |format|
      if @skill.update(skill_params)
        format.html { redirect_to root_path + "#skills", notice: "Skill was successfully updated." }
  ...
  def destroy
    @skill.destroy
    respond_to do |format|
      format.html { redirect_to root_path + "#skills", notice: "Skill was successfully destroyed." }
