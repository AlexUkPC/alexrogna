class EducationsController < ApplicationController
  ...
  private
    ...
    def education_params
      params.require(:education).permit(:school, :location, :start_date, :end_date, :specialization, :courses, :show_on_cv, :present, tech_ids: [], teches_attributes:[:name, :logo, :_destroy])
    end
end
