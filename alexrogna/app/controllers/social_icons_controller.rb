class SocialIconsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @social_icon.save
        format.html { redirect_to root_path + "#hero", notice: "Social icon was successfully created." }
  ...
  def update
    respond_to do |format|
      if @social_icon.update(social_icon_params)
        format.html { redirect_to root_path + "#hero", notice: "Social icon was successfully updated." }
  ...
  def destroy
    @social_icon.destroy
    respond_to do |format|
      format.html { redirect_to root_path + "#hero", notice: "Social icon was successfully destroyed." }
